...
const LeftBlock = () => {
  return (
    <div className="h-screen w-78 gap-3 p-2 pr-4 text-white flex flex-col justify-between text-sm">
      <div>
        <SearchBar />
      ...
      <div className="text-xs">
        ...
        <div className="mt-5">
          Unknown: <a>Unknown</a> · <a>Unknown</a> · <a>Unknown</a> ·{" "}
          <a>Unknown</a>
          {" · "}
          <a>Unknown</a> ·{" "}
          <a href="https://github.com/eqsdxr/mastodon-clone-web">
            View source code
          </a>{" "}
          · v.999.999.999+pr-99999-ea999e
        </div>
      </div>
    </div>
  );
